...
{
    public partial class PermisosEspecialidades : ApplicationForm
    {
        private int _IDUsuario;
        private ModuloUsuario _ModuloUsuarioActual = new ModuloUsuario();
        ModuloLogic ml = new ModuloLogic();
            
        public PermisosEspecialidades(int id)
        {
            InitializeComponent();
            this._IDUsuario = id;
        }
        ...
        public override void MapearADatos()
        {
            ...
            _ModuloUsuarioActual.Modulo.ID = ml.GetOne("Especialidades").ID;
