...
{
    public partial class PermisosUsuarios : ApplicationForm
    {
        private int _IDUsuario;
        private ModuloUsuario _ModuloUsuarioActual;
        ModuloLogic ml = new ModuloLogic();
            
        public PermisosUsuarios(int id)
        {
            InitializeComponent();
            this._IDUsuario = id;
        }
        ...
        {
            ModuloLogic ml = new ModuloLogic();
            _ModuloUsuarioActual = new ModuloUsuario();
            _ModuloUsuarioActual.State = BusinessEntity.States.New;
            _ModuloUsuarioActual.Modulo.ID = ml.GetOne("Usuarios").ID;
