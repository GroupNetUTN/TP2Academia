...
namespace UI.Desktop
{
    public partial class PermisosInscripciones : ApplicationForm
    {
        ...
        public override void MapearADatos()
        {
            ...
            _ModuloUsuarioActual.Modulo.ID = ml.GetOne("Inscripciones").ID;
